...
<tr class='porfolio_line'>
      ...
      <td>
        <input
          type="text"
          class="input-group input-group-sm text-white ticker_input"
      ...
      <td>
        <input
          type="text"
          class="input-group input-group-sm text-white name_input"
          placeholder=""
          disabled
        />
      </td>
      <td class="text-end">
        <input
          type="percentage"
          class="input-group input-group-sm text-white text-end weight_input"
          placeholder="0.00%"
        />
      </td>
      <td style='width:7%;'>
...
function update_total() {
    ...
    if (Math.round(total * 100) / 100 != 1) {
        ...
        note += `<br><button
                    class="btn btn-success btn-sm float-end align-self-end text-small"
                    id="reweight"
                    >
                    reweight to 100%
        </button>`
